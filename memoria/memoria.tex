...
\begin{document}
	...
	Para poder diferenciar estos dos diseños, el componente que implementa GO.JS se nombrará como 'Process Component' y el diseño del producto LUCA que integra el Process Component se llamara 'LUCA Process'.
		...
		El Process-component, como es un proyecto orientado al entorno gráfico y hará las funciones de widget, se ha establecido una arquitectura monocapa, centrándose en ella todos los elementos necesarios para montar una interfaz grádico.
		
		\vspace{5mm}
		
		Para poder realizarlo, se establecera una estructura de clases que se comunicará con un framework Javascript llamado GO.JS a través de Vaadin.
