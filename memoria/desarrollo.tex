...
La figura~\ref{fig:interfazControladora} muestra cómo se verificaron los permisos y privilegios del usuario que utiliza el servicio, para llevarlo a cabo, se comprueba previa ejecución del método, que el usuario tiene, en este caso, los permisos para crear un proceso, una vez verificados esos permisos, se ejecuta el método. Internamente, se llama al servicio propio de la capa de negocio para realizar la operación e persistencia (Figura~\ref{fig:interfazControladoraImpl}).
